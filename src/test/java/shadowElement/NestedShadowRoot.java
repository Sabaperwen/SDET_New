...
public class NestedShadowRoot {
	...
	public static void main(String[] args) {
		...
		WebElement element = (WebElement) js.executeScript("return document.querySelector('#userName')"+".shadowRoot.querySelector('#app2').shadowRoot.querySelector('#pizza')");
...
//	    shadowRoot2.findElement(By.cssSelector("#pizza")).sendKeys("saba");
